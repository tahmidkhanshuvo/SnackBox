...
import apiClient from '../api/api'; // axios instance (must have withCredentials: true)
...
const AppStyles = () => (
  <style>{`
    :root {
      ...
      --ring: 0 0 0 4px rgba(45,121,243,0.15);
    }
    ...
    * , *::before, *::after { box-sizing: border-box; }
    ...
    html, body {
      ...
      background:
        radial-gradient(1000px 600px at 85% 10%, #d7e3ff 0%, transparent 60%),
        radial-gradient(800px 500px at 10% 90%, #ffe9d6 0%, transparent 60%),
        var(--bg);
      color: var(--fg);
      overflow: hidden;
    }
    ...
    /* Fix Chrome autofill white-on-white */
    ...
    /* Role selector */
    .role-selector {
      display: flex; gap: 12px; margin-bottom: 6px; padding: 6px;
      border-radius: 10px; background-color: #f3f4f6;
    }
    ...
    .parallax-subtitle { max-width: 32rem; margin: 0.5rem auto; color: #e5e7eb; }
    ...
    @media (max-width: 1024px) {
      .form-panel { width: 100%; height: 64%; padding: 1rem; }
...
const LoginForm = ({ onLoginSuccess }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    // Choose endpoint + build minimal payload
          ...
          <div className="flex-column">
            ...
            <div className="role-selector">
              ...
              <input
                ...
                name="account_type"
                value="staff"
                checked={formData.account_type === 'staff'}
                onChange={handleInputChange}
              />

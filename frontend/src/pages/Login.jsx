...
const LoginPage = () => {
  ...
  const API_BASE_URL = '/api/auth'; // Replace with your actual API base URL if different
  ...
  const handleFormSubmit = async (e) => {
      e.preventDefault();
      setError(null);
      const endpoint = isLogin ? `${API_BASE_URL}/token` : `${API_BASE_URL}/register`;
      ...
      try {
          ...
          if (isLogin) {
             ...
             try {
                ...
                throw new Error("Login after registration failed: Invalid server response.");
             }

             if(!loginResponse.ok) throw new Error(loginData.message || 'Registration successful, but login failed.');
  ...
  const handleLogout = async () => {
        ...
        try {
            ...
            console.error("Logout failed:", err); // Log error but still clear client state
        } finally {
  ...
  if (loggedInUser) {
      return (
          <div className="logged-in-container">
              ...
              <button className="button-submit" onClick={handleLogout}>Logout</button>
          </div>
      )
  }
      ...
      <form className="form" onSubmit={handleFormSubmit}>
        ...
        {!isLogin && (
            <div className="flex-column">
              ...
              <div className="inputForm">
                ...
                <input type="text" name="name" className="input" placeholder="Enter your Name" value={formData.name} onChange={handleInputChange} required />
              </div>
            </div>
        )}
        ...
        <div className="flex-column">
          ...
          <div className="inputForm">
            ...
            <input type="email" name="email" className="input" placeholder="Enter your Email" value={formData.email} onChange={handleInputChange} required />
          </div>
        </div>
        ...
        <div className="flex-column">
          ...
          <div className="inputForm">
            ...
            <input type={showPassword ? "text" : "password"} name="password" className="input" placeholder="Enter your Password" value={formData.password} onChange={handleInputChange} required />
        ...
        {!isLogin && (
            <div className="flex-column">
                ...
                <div className="inputForm">
                <svg fill="currentColor" height={20} viewBox="-64 0 512 512" width={20} xmlns="http://www.w3.org/2000/svg"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0" /><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0" /></svg>
                <input type={showPassword ? "text" : "password"} name="password_confirmation" className="input" placeholder="Confirm Password" value={formData.password_confirmation} onChange={handleInputChange} required />
                </div>
            </div>
        )}
        ...
        <button className="button-submit">{isLogin ? 'Sign In' : 'Sign Up'}</button>

...
import CustomerOrders from "./pages/customer/Orders.jsx"; // Aliased to avoid conflict
...
import AdminMenu from "./pages/admin/Menu.jsx"; // Aliased to avoid conflict with StaffMenu
import AdminOrders from "./pages/admin/Orders.jsx"; // Aliased to avoid conflict with CustomerOrders
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (user?.role === "admin") {
      if (!route.startsWith("/admin")) goto("/admin/dashboard");
      return;
    }
  ...
  const handleLoginSuccess = (u) => {
    ...
    const dest =
      ...
      u?.role === "admin" ?
      (p.startsWith("/admin") ? p : "/admin/dashboard") :
      (okCustomerPath ? p : "/");
    goto(dest);
    ...
    <>
      ...
      <CartProvider>
        <Layout user={user} onLogout={handleLogout}>
          ...
          {user && !user.staff && user.role !== "admin" && (
            <>
              {route === "/" && (
                <Home

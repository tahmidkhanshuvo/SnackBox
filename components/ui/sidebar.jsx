...
function SidebarProvider({ defaultOpen = true, open, onOpenChange, className, style, children, ...props }) {
  ...
  const setOpenFunc = React.useCallback(
    (value) => {
  ...
  const toggleSidebar = React.useCallback(() => {
    return isMobile ? setOpenMobile((o) => !o) : setOpenFunc((o) => !o);
  }, [isMobile, setOpenFunc, setOpenMobile]);
  ...
  const contextValue = React.useMemo(
    ...
    [state, currentOpen, setOpenFunc, isMobile, openMobile, setOpenMobile, toggleSidebar]
  );
...
// Sidebar Input, Header, Footer, Separator, Content, Group
...
function SidebarContent({ className, ...props }) {
  return <div data-slot="sidebar-content" data-sidebar="content" className={cn("flex min-h-0 flex-1 flex-col gap-2 group-data-[collapsible=icon]:overflow-hidden", className)} {...props} />;
}
